<?php
// navbar.php - Modified to support guest mode
if (!isset($_SESSION)) {
    session_start();
}
...
// Get user data untuk navbar - ONLY IF DATABASE IS AVAILABLE
$cart_count = 0;
$user_data = [];
...
try {
    ...
    if ($is_logged_in) {
        ...
        // Get updated user data (only if logged in)
    ...
    // Database connection failed - continue in guest mode
    error_log("Database connection failed in navbar: " . $e->getMessage());
}
...
<div class="pj-navbar-wrapper">
    ...
    <nav class="navbar">
        ...
        <div class="search-container">
            ...
            <?php else: ?>
                <a href="<?php echo $login_path; ?>" class="btn btn-primary" style="background: var(--button-color); color: white; padding: 0.5rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; transition: all 0.3s ease;">
    ...
    <div class="mobile-nav" id="pj-mobile-nav">
        ...
        <div class="mobile-user-info">
            ...
            <?php else: ?>
                ...
                <a href="<?php echo $login_path; ?>" class="mobile-profile-btn" style="background: var(--button-color); color: white;">
                    <i class="fas fa-sign-in-alt"></i> Login
                </a>
            <?php endif; ?>
        </div>
