<?php
// navbar_display.php - Display component for navbar
// This file should be included where the navbar HTML needs to appear
// It uses variables set by navbar_process.php

// Ensure we have the required variables from navbar_process.php
if (!isset($navbar_user_data)) {
    die("Error: navbar_process.php must be included before navbar_display.php");
}

// Use the variables from navbar_process.php
$user_data = $navbar_user_data;
?>
