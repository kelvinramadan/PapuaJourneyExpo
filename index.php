<?php
//user_dashboard.php - Modified for Guest Mode
// Removed all session requirements and authentication

// Guest user information (default values)
$user_id = null;
$user_name = 'Guest';
...
// Disable review submission for guests
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_review'])) {
    $error_message = "Please login to submit reviews.";
}

// Set cart count to 0 for guests
$cart_count = 0;

// Get approved reviews for testimonials (keep this for display)
$db = getDbConnection();
...
<body>
            ...
            <div style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
                ...
                <div id="notification-overlay" class="notification-overlay">
                    <div class="notification-modal">
                        ...
                        <div class="notification-message">Please login first!</div>
                        <div class="notification-submessage">You need to login to add items to cart</div>
                    </div>
                </div>
    ...
    <?php else: ?>
        ...
        <section class="hero" id="home">
            ...
            <div class="hero-content">
                <span class="hero-badge fade-in">Welcome to Papua Journey!</span>
                <h1 class="hero-title">
        ...
        <!-- Login Notice Modal (replaces review modal for guests) -->
        <div id="loginNoticeModal" class="review-modal">
            <div class="review-modal-overlay" onclick="closeLoginNoticeModal()"></div>
            <div class="review-modal-content">
                <div class="review-modal-header">
                    <h2>Login Required</h2>
                    <span class="close-modal" onclick="closeLoginNoticeModal()">&times;</span>
                </div>
                <div class="review-modal-body">
                    <div class="login-notice">
                        <i class="fas fa-user-circle" style="font-size: 4rem; color: #007bff; margin-bottom: 1rem;"></i>
                        <h3>Please Login First</h3>
                        <p>You need to be logged in to share your travel experiences and write reviews.</p>
                        <div class="login-benefits">
                            <h4>Benefits of logging in:</h4>
                            <ul>
                                <li><i class="fas fa-check"></i> Write and share reviews</li>
                                <li><i class="fas fa-check"></i> Save favorite destinations</li>
                                <li><i class="fas fa-check"></i> Add items to cart</li>
                                <li><i class="fas fa-check"></i> Access personalized recommendations</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="review-modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeLoginNoticeModal()">Cancel</button>
                    <a href="../../login.php" class="btn btn-primary">
    ...
    <script>
        ...
        // ===== LOGIN NOTICE MODAL FUNCTIONS (replaces review modal) =====
        function initializeLoginNoticeModal() {
            const modal = document.getElementById('loginNoticeModal');
            if (!modal) {
                console.error('Login notice modal not found!');
                return;
            }
            ...
            console.log('Login notice modal initialized successfully');
        }

        function openReviewModal() {
            // Redirect to login notice for guests
        ...
        function navigateToCategory(category) {
            // Show login notice when guest tries to access categories
            openLoginNoticeModal();
        }
        ...
        window.openLoginNoticeModal = openLoginNoticeModal;
        window.closeLoginNoticeModal = closeLoginNoticeModal;
